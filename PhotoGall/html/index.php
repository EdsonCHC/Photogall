...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/PhotoGall/css/style.css" type="text/css">
...
<body>
    <div class="navbar-container">
        ...
        <form class="form-container-r" action="">
            <div class="form-content">
                <label for="" data-section="nav" data-value="input" class="linput"><input type="search" placeholder="Búsqueda" autocomplete="off"></label>
                <button class="Sbuttom">
                    <i><img src="../multimedia/iconos/iconB.ico"></i>
                </button>
            </div>
        ...
        <ul class="nav-menu">
            ...
            <li class="ntxt">
                <form class="form-container-m" action="">
                    <div class="form-content">
                        <label for="" data-section="nav" data-value="input" class="linput"><input type="search" placeholder="Búsqueda" autocomplete="off"></label>
        ...
        <nav>
            <!--Menu normal-->
            <ul class="ful">
                <li class="nav-link home"> <a href=" ../html/index.php"  data-section="nav" data-value="home">
                Inicio</a></li>
                <li class="nav-link" id="menu-horizontal"> <a href="../html/Categorias.php"  data-section="nav" data-value="cate">Categorías</a>
                ...
                <li class="nav-link"> <a href="../html/acercade.php"  data-section="nav" data-value="about">Acerca
                        de</a></li>
                <li class="nav-link <?php esconder(); ?>" id="account"> <a href="../html/acount.php"  data-section="nav" data-value="account">Cuenta</a>
                </li>
                <li class="nav-link"><a href="../html/upload.php" data-section="nav" data-value="upload">Subir
                        Imagen</a></li>
    ...
    <header>
        ...
        <div class="hero-header">
            <h1 data-section="header" data-value="title">
                Bienvenido a PhotoGall
            </h1>
            ...
            <a href="https://wallhaven.cc" class="credit" target="_blank">
                <p class="lang" key="item2" data-section="header" data-value="credit">Imagen gracias a Wallhaven.cc</p>
            </a>
        </div>
    ...
    <main class="main-container">
        ...
        $select = mysqli_query($conn, "SELECT Img.id, Img.route, Img.Name, Img.user_id, Img.Category,Img.Place,
        ...
        <div class="colum-content">
            <a href="../html/infofoto.php" target="_blank"><img src="<?php echo $filas["route"]?>" alt="Foto"></a>
