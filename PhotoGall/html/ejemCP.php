...
<body>
    <div class="navbar-container">
        ...
        <ul class="ful">
                ...
                <li class="nav-link categoría"> <a href="../html/Categorias.php" data-section="nav"
                        data-value="cate">Categorías</a></li>
    ...
    <header>
        ...
        <div class="hero-header">
            <h1 data-section="cate" data-value="p">
                Paisajes
            </h1>
    ...
    <main class="main-container">
        ...
        $select = mysqli_query($conn, "SELECT * FROM `image` WHERE Category = 'Paisajes'  ORDER BY RAND()");
        while ($filas=mysqli_fetch_assoc($select)){
        ?>
        <div class="colum-content">
            <a href=""><img src="<?php echo $filas["route"]?>" alt="Foto"></a>
            <div class="info"><?php echo $filas["Name"]?><a href="">Lorem</a></div>
        </div>
        <?php
        }
        ?>
    ...
    <footer class="footer">
        <div class="footer-left">
            ...
            <div class="socials">
                <a href="#"><i><img class="icon" src="../multimedia/iconos/Iconf.ico" alt=""></i></a>
                <a href="#"><i><img class="icon" src="../multimedia/iconos/iconTw.ico" alt=""></i></a>
                <a href="#"><i><img class="icon" src="../multimedia/iconos/iconIG.ico" alt=""></i></a>
            </div>
        </div>
        <ul class="footer-right">
            ...
            <li class="features">
                ...
                <ul class="box">
                    ...
                    <li><a href="../html/login.php" data-section="nav" data-value="login">Iniciar
                            sesión</a></li>
                    <li><a href="../html/signup.php" data-section="nav" data-value="sign up">Registrarse</a></li>
